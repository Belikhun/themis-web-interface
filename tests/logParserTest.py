...
logParserTest.case("[log:{:<9}] Got a runtime of 0.232351 seconds in Test0001".format(target), lambda: True if (logData["test"][0]["runtime"] == 0.232351) else "Test0001 runtime is {}".format(logData["test"][0]["runtime"]))
