	...
	public function save(Array $file) {
		switch ($file["error"]) {
			...
			case UPLOAD_ERR_NO_FILE:
				throw new GeneralException(41, "No file sent!", 400, $file["error"]);
			case UPLOAD_ERR_INI_SIZE:
			case UPLOAD_ERR_FORM_SIZE:
				throw new GeneralException(42, "File limit exceeded!", 400, $file["error"]);
			default:
				throw new GeneralException(-1, "Unknown error while handing file upload!", 500, $file["error"]);
		}
