...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="/static/css/accountPage.css?v=<?php print VERSION; ?>" />
	<!-- Fonts -->
...
<body id="container">
	...
	<script src="/static/js/account.js?v=<?php print VERSION; ?>" type="text/javascript"></script>
